...
const size = computed(() => props.line.options_with_values.find(i => i.name === 'size'))
</script>
...
<div class="t-aspect-square t-w-full t-h-auto">
  ...
  <div class="t-flex t-w-full t-flex-col t-gap-1">
    <div class="t-text-base t-line-clamp-1"><a :href="`/products/${line.handle}`">{{line.title}}</a></div>
    <div class="t-text-base t-line-clamp-1 -t-mt-2 t-uppercase t-text-[#6D7175]">{{line.variant_options[0]}}</div>
